    ...
    <div className={sharedStyles.layout}>
      ...
      <div className="explanation">
        ...
        <p>
          ...
          pages id in Notion) we will automatically create the table for you!
          See{' '}
          <ExtLink href="https://github.com/ijjk/notion-blog#getting-blog-index-and-token">
            here in the readme
          </ExtLink>{' '}
          for finding the new pages id. To get your token from Notion, login and
          look for a cookie under www.notion.so with the name `token_v2`. After
          finding your token and your blogs page id you should be good to go!
        </p>
      </div>
    </div>
  </>
